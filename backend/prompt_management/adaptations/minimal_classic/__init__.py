...
def get_minimal_classic_limits(user_id: int) -> tuple:
    """
    Queries the database to find the count of experience and projects for the user.
    Dynamically adapts the limits to balance vertical page budget for MinimalClassic template.
